...
class User(Base):
    __tablename__ = "user"
    user_id: Mapped[int] = mapped_column(Integer, autoincrement=True)  # for tracking ANON articles in REPO
    username: Mapped[str] = mapped_column(String, primary_key=True)
    role: Mapped[str] = mapped_column(String)
    password: Mapped[str] = mapped_column(String)
    salt: Mapped[str] = mapped_column(String)
    is_muted: Mapped[str] = mapped_column(String)
...
class Chatroom(Base):
    ...
    is_read: Mapped[str] = mapped_column(String)
...
class Article(Base):
    ...
    post_private: Mapped[str] = mapped_column(String)
